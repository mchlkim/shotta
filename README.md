...
<p align="center">
  ...
  <img alt="Version" src="https://img.shields.io/badge/version-1.2.7-brightgreen">
...
- Every Settings pane, including Shortcuts, now fills from the top.

See the [v1.2.7 changelog](CHANGELOG.md#127--2026-09-17) for details.

## New in v1.2.6

- Settings card borders stay visible on non-Retina displays.

See the [v1.2.6 changelog](CHANGELOG.md#126--2026-09-17) for details.
...
- Keep the Settings window the same size when switching tabs.
- Align selectors and their labels, with consistent control widths.
- Center the shortcuts form and magnifier preview, and keep the About footer at the bottom.

See the [v1.2.4 changelog](CHANGELOG.md#124--2026-09-14) for details.
